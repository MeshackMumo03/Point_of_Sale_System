...
const InventoryScreen = () => {
    ...
    const handleUpdateItem = async(id) => {
        try {
            ...
            await updateDoc(itemRef, {
                ...
                stock: parseFloat(editForm.stock) // Changed to parseFloat
            });
    ...
    const formatStockValue = (value) => {
        // Format the stock value to display up to 3 decimal places, but only if needed
            ...
            items.map((item) => ( <
                ...
                className = "border p-4 rounded" > {
                    editingItem === item.id ? ( <
                        ...
                        Stock: { formatStockValue(item.stock) }
                        units <
                        /p> <
                        /div> <
                        /div> <
